                          ...
                          {MapData2.map((value, index) => (
                            <Link href="/#Map_SvgContainer" key={value.id}>
                              <button
                                ...
                                type="button"
                                className="group  relative  bg-white    text-center border-2  transition-all duration-100 delay-75 cursor-pointer focus:outline-none focus:ring focus:bg-red-500 focus:text-white"
                              >
                                <h4 className="px-4 py-2  text-black group-hover:text-white z-10 relative pointer ease-in-out transition-colors">
                                  {value.properties.City},{' '}
                                  {value.properties.State}
